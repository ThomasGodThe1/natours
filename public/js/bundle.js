...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGVhdGhzdG9ybXNhdmlvdXIiLCJhIjoiY2t5eDRpeTY1MDZoejJvcWtyZzc5MzZsOCJ9.7OACbibaW08LwyVHLimeCw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/deathstormsaviour/ckyx4udn1001l14s0bzuk8i49',
    scrollZoom: false
  });
...
var stripe = Stripe('pk_test_51KRIa2ANObgZGC8NhPJzKTjSj6mt0h8DVfEDtm83T6GpymnTwa9OIOIM6glRHi7oy8LhG0GBjPWqM0Svj0NCJYXe003WyDXre6');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Create chechkout form + charge credit card
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var curPassword, password, passwordConfirm, email;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              curPassword = document.querySelector('#password-current').value;
